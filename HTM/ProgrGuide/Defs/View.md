...
[դիտելու ձևի սյուների նկարագրություն](../viewcolumn.md)  
[դիտելու ձևի պարամետրերի նկարագրություն](../ViewParam.md)  
...
| sViewSource | Հիմքային [տվյալների աղբյուրի](Data.md) ներքին անունը: |
