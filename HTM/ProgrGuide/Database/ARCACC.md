<html>
<head>
<title>Таблица ARCACC</title>
</head>

<body>

<h1><font size="4" face="Arial">Таблица ARCACC</font></h1>

<p><font face="Arial">Таблица задает дату архивации учета.<br>
</font></p>
...
<TBODY>
  ...
  <tr>
    ...
    <td width="20%"><font face="Arial">NOT NULL</font></td>
    <td width="40%"><font face="Arial">дата начиная с которой 
	(влючительно) факты находятся в архиве</font></td>
  </tr>
</TBODY>
</table>
