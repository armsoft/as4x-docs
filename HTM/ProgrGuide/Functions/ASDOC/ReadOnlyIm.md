...
<p><strong><font size="4" face="Arial">Свойство ReadOnlyIm</font></strong></p>
...
редактирования реквизита-изображения документа.</font></p>
...
<p><font face="Arial"><em>object.</em><strong>ReadOnlyIm</strong>(<em>RekvName</em>)[=<em>bValue</em>] 
&nbsp;</font></p>

<p><font face="Arial">Синтаксис свойства <strong>ReadOnlyIm</strong>
...
<TBODY>
  ...
  <tr>
	...
	определяющее идентификатор реквизита-изображения документа</font></td>
  </tr>
  <tr>
    <td width="29%"><font face="Arial"><em>bValue</em></font></td>
    <td width="71%"><font face="Arial">логическое выражение, 
	определяющее возможность редактирования указанного реквизита-изображения</font></td>
  </tr>
</TBODY>
</table>
...
<TBODY>
  ...
  <tr vAlign="top">
    ...
    <td width="71%"><font face="Arial">Редактирование 
	реквизита-изображения допустимо</font></td>
  </tr>
  <tr vAlign="top">
    <td width="29%"><font face="Arial">False</font></td>
    <td width="71%"><font face="Arial">Редактирование 
	реквизита-изображения недопустимо</font></td>
  </tr>
</table>
</body>
</html>
