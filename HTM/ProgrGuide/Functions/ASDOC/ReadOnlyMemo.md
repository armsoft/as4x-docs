<html>
<head>
<title>Документ\ReadOnlyMemo</title>
</head>

<body>

<p><font size="4" face="Arial"><strong>Свойство ReadOnlyMemo</strong></font></p>
...
редактирования реквизита-мемо документа.</font></p>
...
<p><font face="Arial"><em>object.</em><strong>ReadOnlyMemo</strong>(<em>RekvName</em>)[=<em>bValue</em>] 
&nbsp;</font></p>

<p><font face="Arial">Синтаксис свойства <strong>ReadOnlyMemo</strong>
...
<TBODY>
  ...
  <tr>
	...
	определяющее возможность редактирования указанного реквизита-мемо</font></td>
  </tr>
</TBODY>
</table>
...
<TBODY>
  ...
  <tr vAlign="top">
    ...
    <td width="71%"><font face="Arial">Редактирование реквизита-мемо 
	допустимо</font></td>
  </tr>
  <tr vAlign="top">
