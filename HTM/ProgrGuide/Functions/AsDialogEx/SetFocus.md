<html>
<head>
<title>Описательный диалог\SetFocus</title>
</head>
...
<p><font face="Arial">Передается фокус элементу управления с указанным 
идентификатором.</font></p>

<p class="label">&nbsp;</p>

<p class="label"><font face="Arial"><b>Синтаксис</b></font></p>

<p><font face="Arial"><em>object.</em><strong>SetFocus(</strong><em>sControlName</em><strong>)</strong></font></p>

<p><font face="Arial">Синтаксис свойства <strong>SetFocus</strong>
