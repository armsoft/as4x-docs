<html>
<head>
<title>Текущий вид просмотра\AllowView</title>
</head>
...
просмотр документа из текущего вида просмотра.</font></p>
...
<br>
</b><em>object</em><strong>.AllowView </strong>[=<em>bValue</em>]&nbsp;</font></p>

<p><font face="Arial">Синтаксис свойства <b>Allow</b><strong>View</strong>
...
<TBODY>
  ...
  <tr vAlign="top">
    ...
    <td width="71%"><font face="Arial">Не разрешать просмотр документа</font></td>
  </tr>
  <tr vAlign="top">
    <td width="29%"><font face="Arial">True</font></td>
    <td width="71%"><font face="Arial">Разрешать просмотр документа</font></td>
  </tr>
</TBODY>
</table>
</body>
