<html>
<head>
<title>Текущий вид просмотра\AllowEdit</title>
</head>
...
корректировку документа из текущего вида просмотра.</font></p>
...
<br>
</b><em>object</em><strong>.AllowEdit </strong>[=<em>bValue</em>]&nbsp;</font></p>

<p><font face="Arial">Синтаксис свойства <b>AllowEdit</b>
...
<TBODY>
  ...
  <tr vAlign="top">
	...
	разрешающее корректировку документа</font></td>
  </tr>
</TBODY>
</table>
...
<TBODY>
  ...
  <tr vAlign="top">
    ...
    <td width="71%"><font face="Arial">Не разрешать корректировку 
	документа</font></td>
  </tr>
  <tr vAlign="top">
    <td width="29%"><font face="Arial">True</font></td>
    <td width="71%"><font face="Arial">Разрешать корректировку 
	документа</font></td>
  </tr>
</TBODY>
</table>
