<html>
<head>
<title>Вид просмотра\RemoveColumn</title>
</head>

<body>

<p><strong><font size="4" face="Arial">Метод RemoveColumn<br>
<br>
</font></strong><font face="Arial"><a href="../Asview.html">См. также</a>&nbsp;
<a href="../../Examples/E_AsView.html">Пример</a>&nbsp; <a href="../Asview.html">
Применяется к</a></font></p>

<p class="label"><font face="Arial">Удаляет из данного вида колонку.</font></p>

<p class="label">&nbsp;</p>

<p class="label"><font face="Arial"><b>Синтаксис</b></font></p>

<p><font face="Arial"><em>object.</em><strong>RemoveColumn </strong><em>
sColName</em></font></p>
...
<TBODY>
  ...
  <tr>
	...
	определяющее идентификатор удаляемой колонки</font></td>
  </tr>
</table>
